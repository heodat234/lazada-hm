               ...
               <div class="col-xs-12 col-sm-12 col-md-12">
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        ...
                        <input type="text" class="form-control so" name="gia_nhap" >
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        ...
                        <input type="text" class="form-control so" name="so_luong" >
                     </div>
                  </div>
               </div>
            </div>
...
<script type="text/javascript">
  ...
  var gia_nhap = $(e.relatedTarget).data('gianhap');
  var so_luong = $(e.relatedTarget).data('soluong');
  //populate the textbox
  $(e.currentTarget).find('input[name="id_sanpham"]').val(id_sp);
  $(e.currentTarget).find('input[name="ten_sanpham"]').val(ten_sp);
  $(e.currentTarget).find('input[name="gia_nhap"]').val(gia_nhap);
  $(e.currentTarget).find('input[name="so_luong"]').val(so_luong);
...
$('#btn-add').on('click',function(){
  ...
  var gia = frm.get('gia_nhap');
  var so_luong = frm.get('so_luong');
      $.ajax({
        url:route,
        processData:false,
        contentType:false,
